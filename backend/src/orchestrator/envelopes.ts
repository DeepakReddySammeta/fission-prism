    ...
    createSurface(surfaceId, 'Books', '#f25011'),
    {
      ...
      updateComponents: {
        ...
        components: [
          ...
          { id: 'br_body', component: 'Column', weight: 1, gap: 6, children: ['br_title', 'br_authors', 'br_year', 'br_subjects'] },
    ...
    createSurface(surfaceId, 'Movies', '#e50914'),
    {
      ...
      updateComponents: {
        ...
        components: [
          ...
          { id: 'mr_body', component: 'Column', weight: 1, gap: 6, children: ['mr_title', 'mr_year', 'mr_rating', 'mr_overview'] },
